...
if ($_SERVER['HTTP_HOST']=='localhost') {
	$debug = TRUE;
	define ('BASE_URI', '/var/www/its450000.com/');
	define ('BASE_URL',	'http://localhost/var/www/its450000.com');
	define ('MYSQL', '/var/www/its450000.com/mysql_connect.inc.php');
} else {
	define ('BASE_URI', '/var/www/its450000.com/');
	define ('BASE_URL',	'http://its450000.com/');
	define ('MYSQL', '/var/www/its450000.com//mysql_connect.inc.php');
}
